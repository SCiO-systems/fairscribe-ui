...
import OrgsPersonsEntities from '../OrgsPersonsEntities';
...
const ResourceRights = ({ mandatory, initialData, setter, mode }) => {
	...
	const triggerAutocomplete = ({ query }, term, setSuggestions) => {
			...
			<div id="resource-rights" className="p-fluid">
				<div className="p-formgrid p-grid p-d-flex p-ai-end">
					<div className="p-field p-col-12 p-md-5">
						{mandatory.rights ? <label htmlFor="accessRights" style={{ color: 'red', margin: '0' }}>{t('RESOURCE_ACCESS_RIGHTS')} *</label> : <label htmlFor="accessRights" style={{ margin: '0' }}>{t('RESOURCE_ACCESS_RIGHTS')}</label>}
						<Dropdown
							id="accessRights"
					...
					<div className={mode === 'edit' ? 'p-field p-col-8 p-md-5' : 'p-field p-col-12 p-md-7'}>
						{mandatory.rights ? <label htmlFor="accessRights" style={{ color: 'red', margin: '0' }}>{t('RESOURCE_LICENSE')} *</label> : <label htmlFor="accessRights" style={{ margin: '0' }}>{t('RESOURCE_LICENSE')}</label>}
						<Dropdown
